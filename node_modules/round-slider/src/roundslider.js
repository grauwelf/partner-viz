    ...
    RoundSlider.prototype = {
        ...
        _createLayers: function () {
            ...
            if (this._rangeSlider || this._showRange) {
                ...
                this.block4 = path.clone().addClass("rs-path-color").css({ "opacity": "1", "z-index": "1" }).rsRotate(start - 180);
                
                this.block5 = path.clone().addClass("rs-range-color").addClass("rs-range-over").rsRotate(start);
                this.block6 = path.clone().addClass("rs-range-color").addClass("rs-range-over").css("opacity", "0").rsRotate(start);
                this.block7 = path.clone().addClass("rs-path-color").addClass("rs-range-over").rsRotate(start);
                this.block8 = path.addClass("rs-path-color").addClass("rs-range-over").css({ "opacity": "1", "z-index": "1" }).rsRotate(start - 180);
                
                this.block.append(this.block1, this.block2, this.block3, this.block4,
                        this.block5, this.block6, this.block7, this.block8).addClass("rs-split");
            }
        ...
        _changeSliderValue: function (value, angle) {
            ...
            if (!this._rangeSlider && !this._showRange) {
                ...
                this.block6.css("opacity", o2);
                this.block7.css("opacity", o3);

                (this._active == 1 ? this.block4 : this.block2).rsRotate(lAngle - 180);
                (this._active == 1 ? this.block1 : this.block3).rsRotate(lAngle);
                
                (this._active == 1 ? this.block8 : this.block6).rsRotate(lAngle - 180);
                (this._active == 1 ? this.block5 : this.block7).rsRotate(lAngle);
            }
        },
        // WAI-ARIA support
